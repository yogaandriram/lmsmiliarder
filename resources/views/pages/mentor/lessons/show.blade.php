...
<div class="space-y-6">
  <div class="flex items-center justify-between">
    <div>
      ...
      <p class="text-white/70">Modul: {{ $module->title }} • Kursus: {{ $course->title }}</p>
    </div>
    <div class="flex gap-2">
      <x-ui.btn-secondary href="{{ route('mentor.courses.modules.show', [$course,$module]) }}" icon="fa-solid fa-arrow-left">Kembali ke Modul</x-ui.btn-secondary>
    </div>
  </div>
