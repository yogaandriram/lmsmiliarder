  ...
  <div class="min-h-[60vh] flex items-center justify-center">
    <div class="glass w-full max-w-lg rounded-2xl p-8 text-center space-y-4">
      <div class="flex justify-center">
        <i class="fa-solid fa-triangle-exclamation text-yellow-300 text-5xl"></i>
      </div>
      <h1 class="text-3xl font-bold">Halaman Tidak Ditemukan</h1>
      <p class="text-sm text-neutral-400">Kode: <span class="font-mono">404</span></p>
      <p class="text-neutral-200">Maaf, halaman yang kamu cari tidak tersedia atau sudah dipindahkan.</p>
