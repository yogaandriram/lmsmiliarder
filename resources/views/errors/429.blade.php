  ...
  <div class="min-h-[60vh] flex items-center justify-center">
    <div class="glass w-full max-w-lg rounded-2xl p-8 text-center space-y-4">
      <div class="flex justify-center">
        <i class="fa-solid fa-gauge-high text-teal-300 text-5xl"></i>
      </div>
      <h1 class="text-3xl font-bold">Terlalu Banyak Permintaan</h1>
      <p class="text-sm text-neutral-400">Kode: <span class="font-mono">429</span></p>
      <p class="text-neutral-200">Harap tunggu beberapa saat sebelum mencoba kembali.</p>
