...
<form method="POST" action="{{ url('/register') }}" class="space-y-4 text-gray-900 dark:text-gray-100">
    @csrf
    <h2 class="text-xl font-semibold text-gray-900 dark:text-gray-100 text-center">Registrasi Akun</h2>
...
<x-ui.auth.input label="Konfirmasi Kata Sandi" name="password_confirmation" type="password" placeholder="********" icon="fa-solid fa-lock" required showToggle="true" />
